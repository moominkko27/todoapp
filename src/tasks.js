...
getTasks = async function () {
  ...
  try {
    ...
    const sql =
      ...
      /** FROM t_task inner join m_category ON t_task.category_id = m_category.category_id inner join m_user ON t_task.user_id = m_user.user_id WHERE m_user.user_id = ?;";
      let d = [user_id];*/
